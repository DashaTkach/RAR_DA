...
#  Ответ: (-0.004464240825446246, 0.006875642131528499)
...
#  Ответ: (0.0029487800625081573, 0.003886590627367173)
...
print(student_test(result, 0))  # правильны ли вводные данные?
#  Ответ: (0.41803439881983745, 0.6761440701637369)

# задание 10 - уровень значимости гипотезы о нормальном законе распределения
k, p = lilliefors(result)
print('k: %.3f p-value: %.3f' % (k, p))
#  Ответ: k: 0.123 p-value: 0.001
